...
Esta pasta reúne os fluxos operacionais canônicos do `blueocean-brain-openclaw`.

Playbook não é prompt longo nem roteador de comando. É a forma padrão de conduzir um tipo de leitura ou decisão.
...
## Regra de desenho
Cada playbook deve:
- ser curto o bastante para ser usado
- ser forte o bastante para evitar ambiguidade
- apontar para canon e knowledge, não duplicar tudo
- explicitar quando pode seguir, quando precisa subir e quando deve travar
